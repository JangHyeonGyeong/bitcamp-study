...
// 1) DB커넥션 객체를 만드는 메서드를 준비한다. : DataSource 
// 2) 트랜잭션 관리자준비 : PlatformTransactionManager
...
public class AppConfig {
  ...
  // 메서드가 리턴한 객체는 @Bean 애노테이션에 지정된 이름으로
  // 컨테이너에 보관될 것이다 
  @Bean("dataSource")
  ...
  public ViewResolver createViewResolver() {
    ...
    // 주어진 URL을 처리할 객체 -> JSP를 실행 시켜주는 객체 
