...
CREATE TABLE ems_lecture (
  ...
  COL   MEDIUMTEXT   NULL     COMMENT '강의내용', -- 강의내용
...
CREATE TABLE ems_center (
  ...
  ano       INTEGER      NOT NULL COMMENT '기본주소번호', -- 기본주소번호
  det_adder VARCHAR(255) NOT NULL COMMENT '상세주소', -- 상세주소
  tel       VARCHAR(30)  NOT NULL COMMENT '대표번호', -- 대표번호
  fax       VARCHAR(30)  NULL     COMMENT '팩스', -- 팩스
  hompate   VARCHAR(255) NULL     COMMENT '홈페이지' -- 홈페이지
)
COMMENT '교육센터';
