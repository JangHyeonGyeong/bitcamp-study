...
import com.eomcs.oop.ex02.test.domain.Score00_1;
...
public class Test00 {
  ...
  public static void main(String[] args) {
    ...
    Score00_1 s1 = new Score00_1 ("홍길동", 100, 90, 85) ; 
    printScore(s1);


    Score00_1 s2 = new Score00_1 ("임꺽정", 90, 80, 75) ; 
    printScore(s2);


    Score00_1 s3 = new Score00_1 ("유관순", 80, 70, 65) ; 
    printScore(s3);
  }

  static void printScore(Score00_1 s) {
