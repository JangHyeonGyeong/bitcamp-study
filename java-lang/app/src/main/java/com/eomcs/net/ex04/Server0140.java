    ...
    try (Scanner keyboard = new Scanner(System.in);
      ...
      loop: while (true) {
        ...
        try (Socket socket = serverSocket.accept();
          ...
          InetAddress inetAdrre  = socket.getInetAddress() ;
          System.out.printf("접속자 : %s\n",inetAdrre.getHostAddress());
          // if(inetAdrre.getHostAddress().equals("127.0.0.1"));
          ...
          while (true) {
            ...
            if (name.equalsIgnoreCase("quit")) { // 클라이언트와 연결 끊기
              ...
              break;
                ...
                // 로컬호스트에서만 서버를 멈출 수 있다.
                && inetAdrre.getHostAddress().equals("127.0.0.1")) { // 서버 종료하기
